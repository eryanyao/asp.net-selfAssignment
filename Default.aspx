...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="w3-padding-large" id="main">
        ...
        <header class="w3-container w3-padding-32 w3-center w3-black" id="home">
            ...
            <div class="card">
                <asp:image ID="img1" runat="server" src="img/photo-grey.jpg" alt="boy" class="w3-image" width="992" height="1108" />
                <asp:image ID="img2" runat="server" src="img/photo.jpg" alt="boy" class="img-top w3-image" width="992" height="1108" />
            </div>

                                                    ...
                                                    <td>
                                                        <div>
                                                            ...
                                                            <table class="imgTabel" runat="server">
                                                                <tr>
                                                                    <td style="width: 150px; text-align: center; height: 150px;">
                                                                        <asp:ImageButton ID="leftbtn2" runat="server" ImageAlign="AbsMiddle" ImageUrl="~/img/btn_l.png" Width="80px" Height="80px" OnClick="leftbtn2_Click" />
                                                                    </td>
                                                                    <td style="width: 200px; text-align: center;">
                                                                        <h2>
                                                                    ...
                                                                    <td style="width: 150px; text-align: center;">
                                                                        <asp:ImageButton ID="rightbtn2" runat="server" ImageAlign="AbsMiddle" ImageUrl="~/img/btn_r.png" Width="80px" Height="80px" OnClick="rightbtn2_Click" />
                                                                    </td>
                                                                </tr>
                                                                <tr style="border: dashed;">
                                                                    <td colspan="3" style="margin: 0px auto; text-align: center;">

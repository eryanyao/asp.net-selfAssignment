        ...
        <div class="w3-content w3-justify w3-text-white w3-padding-64" id="feedback">
            ...
            <asp:MultiView ID="multiviewfb" runat="server" ActiveViewIndex="0">
                <asp:View ID="view1" runat="server">
                    ...
                    <asp:TextBox ID="txtName" runat="server" placeholder="Name" TextMode="SingleLine"></asp:TextBox>&nbsp;
                    <asp:Button ID="btn1" runat="server" Text="Enter" OnClick="btn1_Click"  ValidationGroup="valid1" /><br />
                    <asp:RequiredFieldValidator ID="rfvName" runat="server" CssClass="valid" ControlToValidate="txtName" ErrorMessage="Field Required." Display="Dynamic" ValidationGroup="valid2" ></asp:RequiredFieldValidator>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" CssClass="valid" ControlToValidate="txtName" ErrorMessage="Field Required." Display="Dynamic" ValidationGroup="valid1" ></asp:RequiredFieldValidator>
                    ...
                    <asp:TextBox ID="txtAge" runat="server" placeholder="Age" TextMode="Number"></asp:TextBox>&nbsp;
                    <asp:Button ID="btn2" runat="server" Text="Enter" OnClick="btn2_Click" ValidationGroup="valid3" /><br />
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" CssClass="valid" ControlToValidate="txtAge" ErrorMessage="Field Required." Display="Dynamic" ValidationGroup="valid2"></asp:RequiredFieldValidator>
                    ...
                    <asp:TextBox ID="txtRange" runat="server" TextMode="Range" AutoPostBack="true" 
                        Text="" OnTextChanged="txtRange_TextChanged"></asp:TextBox>
                    <asp:TextBox ID="txt1Range" CssClass="txtrange" runat="server" TextMode="Number" 
                        Text="" AutoPostBack="true" OnTextChanged="lblRange_TextChanged" Width="60px"></asp:TextBox>(0-100)<br />
                    <asp:RequiredFieldValidator CssClass="valid" ID="rfvRange" ControlToValidate="txt1Range" runat="server" ErrorMessage="Field Required." ValidationGroup="valid2" Display="Dynamic"></asp:RequiredFieldValidator>
                    <asp:RangeValidator CssClass="valid" ID="rvRange" runat="server" ControlToValidate="txt1Range" 
                        Type="Integer" MaximumValue="100" MinimumValue="0" ErrorMessage="Please enter number 0 - 100."
                         Display="Dynamic" ValidationGroup="valid2"></asp:RangeValidator><br />

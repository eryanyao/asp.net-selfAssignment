                        ...
                        <table>
                            ...
                            <tr>
                                ...
                                <td class="valid">
                                    ...
                                    <asp:CompareValidator ID="cvLname" runat="server" ControlToValidate="txtLname" ControlToCompare="txtFname" ErrorMessage="The first name and last name cannot be same." Display="Dynamic" Operator="NotEqual"></asp:CompareValidator>                               
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td class="valid">
                                    <asp:RequiredFieldValidator ID="rfvContact" runat="server" ControlToValidate="txtContact" ErrorMessage="Please enter your phone number." Display="Dynamic" ValidationGroup="valid1"></asp:RequiredFieldValidator>
                            ...
                            <tr>
                                ...
                                <td class="valid">
                                    <asp:CompareValidator ID="cvCountry" runat="server" ControlToValidate="ddlCountry" 
                                        ValueToCompare="-Select Country-" Operator="NotEqual" ErrorMessage="Please select your country." Display="Dynamic" ValidationGroup="valid1"></asp:CompareValidator>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="box">
                                    <asp:DropDownList ID="ddlState" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlState_SelectedIndexChanged"
                                         DataSourceID="xmlState" DataTextField="name" DataValueField="name" Width="150px" Height="35px" Enabled="false"></asp:DropDownList>
                                    <asp:DropDownList ID="ddlCity" runat="server" DataSourceID="" DataValueField="name" DataTextField="name"
                                         Width="155px" Height="35px" Enabled="false"></asp:DropDownList>
                            ...
                            <tr>
                                ...
                                <td class="box">
                                    ...
                                    <asp:ImageButton ID="btnCalendar" runat="server" ImageUrl="~/img/calendar.jpg" OnClick="btnCalendar_Click" ImageAlign="Middle" CausesValidation="false" />
                                ...
                                <td class="valid">
                                    <asp:RequiredFieldValidator ID="rfvDate" runat="server" ControlToValidate="txtDate" ErrorMessage="Please select the appointment date." ValidationGroup="valid1" Display="Dynamic" ></asp:RequiredFieldValidator>
                                    <asp:RegularExpressionValidator ID="revDate" runat="server" ControlToValidate="txtDate" 
                                        ErrorMessage="Please enter following date format.(DD/MM/YYYY)" 
                                        ValidationExpression="^(0[1-9]|[12][0-9]|3[01])[-/.](0[1-9]|1[012])[-/.](19|20)\d\d$"
                                         ValidationGroup="valid1" Display="Dynamic"></asp:RegularExpressionValidator>     
                                </td>
                            </tr>
                            <tr>
                                <td></td>
